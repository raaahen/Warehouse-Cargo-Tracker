...
import ru.stepanovgzh.wma.receivingms.cqrs.command.DeleteReceivingOrderCommand;
...
import ru.stepanovgzh.wma.receivingms.data.input.AddDetailToReceivingOrderInput;
import ru.stepanovgzh.wma.receivingms.data.input.CreateReceivingOrderInput;
import ru.stepanovgzh.wma.receivingms.data.input.DeleteReceivingOrderInput;
import ru.stepanovgzh.wma.receivingms.data.input.ReceiveCargoInput;
import ru.stepanovgzh.wma.receivingms.data.input.RemoveDetailFromReceivingOrderInput;
