package ru.stepanovgzh.wct.storingms.projection;
...
import ru.stepanovgzh.wct.storingms.data.mapper.CargoMapper;
import ru.stepanovgzh.wct.storingms.data.model.Cargo;
import ru.stepanovgzh.wct.storingms.data.repository.CargoRepository;
